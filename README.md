...
8. 複数小節の「コピー」や「ペースト」もできます。コピーしたい部分の先頭で長押しすると、複数マス（拍）の選択モードになります。コピーしたい範囲が反転するようにタップしていき、改めて選択範囲上で長押しすると、「コピー」「カット」「削除」などが選択できます。貼り付けたい箇所で長押しすると、「挿入貼り付け」「上に貼り付け」が選択できます。
