...
|4|coda|ダ・カーポ、ダル・セーニョで戻ったあと、次のヴィーデ（vide）またはコーダ（集結部）まで飛ぶ。|
...
|5|[D.C. al Fine](./html/DCalCoda.html)|<img src="images/DCalCoda.png" alt="image">|再生順：<br>「ABCAB ABCAB ABCAB」<br>D.S. で曲の最初に戻り、al Fine でFineのところで終わる。|
|6|[D.C. al Fine](./html/Fine.html)|<img src="images/fine.png" alt="image">|再生順：<br>「ABCAB ABCAB ABCAB」<br>D.S. で曲の最初に戻り、al Fine でFineのところで終わる。|
|7||||
|8||||
|9||||
|10||||
